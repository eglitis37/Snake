...
public class SnakeWorld  extends World
{
     ...
     * @param d is the dot number
     * @return and integer that represents the x coordinate
     */
     ...
     * @param d is the dot number
     * @return and integer that represents the y coordinate
     */
    ...
    /**
     * addFood will add a random number (1 or 2) food objects in to the world
     * @param there are no parameters
     * @return nothing is returned
     */
    public void addFood()
    ...
    /**
     * addDot will add a new object to the end of our snake
