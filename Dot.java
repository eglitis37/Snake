...
public class Dot  extends Actor
{
    ...
    public Dot(int dot){
        GreenfootImage image1 = new GreenfootImage("SnakeHead1.gif");
    ...
    private void lookForEdge()
    {
        if( isAtEdge() )
        {
            getWorld().showText("You Have Lost!\nPress Run To Play Again.", getWorld().getWidth()/2, getWorld().getHeight()/2);
            Greenfoot.stop();
        }
    }
    
    /**
     * lookForFood checks if our Snake is touching Food and then grows it's taill if we have eaten food
     * @param There are no parameters
     * @retrun Nothing is returned
     */
    ...
    /**
     * lookForDot will check if the snake has hit it's body of our world and end game
     * @param There are no parameters
    ...
    /**
     * growTail will add a dot to the end of the snake when we eat a Food object
     * @param There are no parameters
     * @return There is nothing to return
     */
